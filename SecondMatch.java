...
public class SecondMatch extends JFrame implements ActionListener
{
...
if(e.getSource()==srateplayer9)
		{
			...
			try
		   {
			...
			ps.setString(5,btplay9.getText());
						int i=ps.executeUpdate();
			JOptionPane.showMessageDialog(this," record updated !");
			con.close();
 		    }
...
if(e.getSource()==srateplayer10)
		{
			...
			try
		   {
			...
			ps.setString(5,btplay10.getText());
						int i=ps.executeUpdate();
			JOptionPane.showMessageDialog(this," record updated !");
			con.close();
 		    }
...
//***********************************************************************************
		...
		if(e.getSource()==srateplayer11)
		{
			...
			try
		   {
			Class.forName("oracle.jdbc.driver.OracleDriver");
			Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","cdac","cdac");
			PreparedStatement ps=con.prepareStatement("update player_id_details set  bating_run=?,ball=?, bating_six=?, bating_four=? where  player_id=?");
			...
			ps.setString(5,btplay11.getText());
						int i=ps.executeUpdate();
			JOptionPane.showMessageDialog(this," record updated !");
			con.close();
 		    }
