...
import java.sql.*;
public class TableDemobyoneplayer extends JFrame
{
	Container c;
	JTable t;
	String s1;
	TableDemobyoneplayer(String msg)
	{
		...
		try
		{
			...
			PreparedStatement ps=con.prepareStatement("select * from player_id_details where player_id=?");
			ps.setString(1,s1);
	...
	{
		new TableDemobyoneplayer("P1469");
	}
}